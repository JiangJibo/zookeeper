 ...
 * Zookeeper客户端命令行,  zkCli.cmd,  zkCli.sh
 */
    ...
    protected boolean processZKCmd(MyCommandOptions co)
        ...
        if (cmd.equals("create") && args.length >= 3) {
            ...
            zk.sync(path, new AsyncCallback.VoidCallback() {
                public void processResult(int rc, String path, Object ctx) { System.out.println("Sync returned " + rc); }
            }, null);
